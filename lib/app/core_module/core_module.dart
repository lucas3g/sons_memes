...
import 'package:sons_memes/app/core_module/services/sqflite/adapters/table_entity.dart';
import 'package:sons_memes/app/core_module/services/sqflite/sqflite_service.dart';
    ...
    AsyncBind<ISQLFliteStorage>(
      (i) async {
        ...
        final meusAudiosfields = {
          ...
          const TableFieldEntity(name: 'categoria', type: FieldType.string),
